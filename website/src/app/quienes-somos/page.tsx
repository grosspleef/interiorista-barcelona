    ...
    content: (
      <>
        ...
        <p>
          ...
          obra del Ayuntamiento de Barcelona, normativa urbanística del Plan
    ...
    content: (
      <>
        <p>
          ...
          para cada proyecto, combinando las tendencias actuales del diseño con
          las particularidades arquitectónicas de Barcelona.
        </p>
        <p>
          Cada propuesta está pensada para maximizar el potencial de tu espacio
          y{' '}
          <strong className="font-semibold text-neutral-950">
            añadir valor a tu bien inmobiliario
          </strong>
          , ya sea un piso modernista en el Eixample, un ático en Gràcia o un
          loft en Poblenou.
        </p>
      </>
    ),
...
const schemaOrg = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description:
        'Colectivo de más de 25 interioristas, arquitectos de interior, decoradores y paisajistas titulados y asegurados en Barcelona.',
      address: {
        '@type': 'PostalAddress',
...
export default function QuienesSomosPage() {
  return (
    <RootLayout>
      ...
      {/* 1. Hero */}
      <PageIntro eyebrow="Nuestro colectivo" title="¿Quiénes somos?">
        <p>
          Interiorista. es un{' '}
          <strong className="font-semibold text-neutral-950">
            colectivo a escala humana
          </strong>{' '}
          que reúne a más de 25 profesionales del diseño de interiores que
        ...
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          <p>
            ...
            y asegurado, que comparte una misma visión: ofrecer un{' '}
            <strong className="font-semibold text-neutral-950">
              diseño 100% personalizado
            </strong>
            , adaptado a tu estilo de vida, tu presupuesto y las
            particularidades arquitectónicas de Barcelona.
          </p>
          <p>
            Desde pisos modernistas en el Eixample hasta áticos con terraza en
            Gràcia, pasando por lofts industriales en Poblenou, nuestros
            interioristas conocen a fondo la ciudad y sus barrios para
            transformar cada espacio en un lugar único.
          </p>
        </div>
      </PageIntro>
      ...
      {/* 3. Una gestión integral */}
      <div className="mt-24 rounded-4xl bg-neutral-950 py-24 sm:mt-32 lg:mt-40 lg:py-32">
        <SectionIntro
          eyebrow="Proceso"
          title="Una gestión integral de tu proyecto"
          invert
        >
          <p>
            Desde la primera toma de contacto hasta la entrega de llaves, te
            acompañamos en cada etapa con un único interlocutor dedicado.
          </p>
        </SectionIntro>
        <Container className="mt-16">
          <FadeInStagger>
            ...
            >
              <GridListItem title="Solicitud de proyecto" invert>
                Envías tu solicitud a través de nuestro formulario con los
                detalles de tu proyecto: superficie, tipo de vivienda,
                presupuesto estimado y ubicación en Barcelona.
              </GridListItem>
              <GridListItem title="Cita telefónica" invert>
                Un coordinador del colectivo te contacta para comprender tus
                necesidades y seleccionar al interiorista más adecuado para tu
                proyecto.
              </GridListItem>
              ...
              <GridListItem title="Estudio y seguimiento de la obra" invert>
                Desarrollo completo del proyecto, coordinación de gremios y
