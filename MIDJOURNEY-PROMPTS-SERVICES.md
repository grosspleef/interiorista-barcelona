...
**Contexte :** Page de service principale pour le diseño de interiores à Barcelona. Les 3 premières images montrent des **projets finis, luxueux, avec des styles variés** (penthouse contemporain, art déco modernista, loft industriel) — sans lien avec les étapes du processus. La 4e image (PricingBlock) reste une ambiance salon méditerranéen. Styles variés pour montrer la diversité des projets barcelonais.

---

### DI-1 — Penthouse minimaliste contemporain (Diagonal Mar)
**Ratio :** `16:9` · **Fichier SEO :** `diseno-interiores-penthouse-minimalista-barcelona.jpg`
**Remplace :** `whiteboard.jpg` dans `Section title="Visita consejo con tu diseñador de interiores"`

```
A stunning editorial photograph of a luxurious ultra-contemporary penthouse in Barcelona's Diagonal Mar district, shot for Architectural Digest. The scene captures a dramatic double-height living space with floor-to-ceiling panoramic glass walls offering a breathtaking view of the Mediterranean Sea and the Barcelona coastline. The interior is designed in a refined minimalist style with a restrained palette of warm neutrals — white Calacatta marble floors with subtle gold veining, walls in smooth matte plaster in warm ivory, and rich walnut wood accents. A sculptural open staircase in brushed steel and tempered glass connects the two levels, its clean geometric lines creating a striking architectural focal point. The living area features a low-profile modular sofa in cream bouclé fabric arranged around a monolithic coffee table carved from a single block of white Carrara marble. Walnut built-in cabinetry with invisible push-to-open doors lines one wall. A minimalist fireplace with a long horizontal opening is set into a smooth concrete feature wall. Recessed lighting and a single oversized sculptural pendant in white blown glass provide warm ambient light. The late afternoon sun streams through the glass walls, casting long golden reflections across the marble floor and illuminating the space with warm Mediterranean light. The design is serene, sophisticated, and effortlessly luxurious — a masterclass in contemporary minimalism. Photographed with a Canon EOS R5 and a 24mm wide-angle lens, photorealistic, ultra-detailed, 8K resolution. The space is empty with no people, no visible text, no watermarks, and no logos.
```

---

### DI-2 — Appartement art déco modernista (Eixample)
**Ratio :** `16:9` · **Fichier SEO :** `diseno-interiores-art-deco-modernista-eixample.jpg`
**Remplace :** `laptop.jpg` dans `Section title="Estudio del proyecto de diseño de interiores"`

```
A breathtaking editorial photograph of a beautifully renovated art déco and modernista apartment in Barcelona's Eixample district, shot for Architectural Digest. The scene captures a grand living room that masterfully blends original early 20th-century architectural details with luxurious mid-century modern furnishings. The ceiling features meticulously restored ornate plaster moldings with floral and geometric motifs, painted in their original soft white with subtle gold-leaf accents at the medallion centers. The floor is covered in stunning original hydraulic cement tiles — an intricate repeating pattern in deep emerald green, warm ochre, cream, and terracotta — perfectly preserved and gleaming. The walls are finished in a rich deep emerald green limewash, creating a dramatic backdrop. A pair of mid-century armchairs in deep emerald velvet with polished brass legs flank a round side table in Verde Guatemala green marble. A large curved sofa in ivory bouclé fabric sits opposite, adorned with cushions in emerald silk and burnished gold velvet. A statement vintage chandelier — a cascading design in polished brass with frosted glass globes — hangs from the ornate ceiling medallion, casting a warm golden glow. Against one wall, a brass and glass vitrine displays curated ceramic objects and art books. The tall shuttered windows are open, their original wooden frames painted in cream, revealing wrought-iron juliet balconies with organic modernista curves. Warm afternoon light floods through sheer ivory curtains, creating a luminous atmosphere that highlights the rich interplay of emerald, brass, velvet, and heritage architectural details. Photographed with a Canon EOS R5 and a 35mm lens, photorealistic, ultra-detailed, 8K resolution. The room is empty with no people, no visible text, no watermarks, and no logos.
```

---

### DI-3 — Loft industriel chic (Poblenou)
**Ratio :** `16:9` · **Fichier SEO :** `diseno-interiores-loft-industrial-poblenou-barcelona.jpg`
**Remplace :** `meeting.jpg` dans `Section title="Seguimiento de obra y coordinación de gremios"`

```
A stunning editorial photograph of a renovated industrial loft in a former textile factory in Barcelona's Poblenou district, shot for Architectural Digest. The scene captures a vast open-plan living space with soaring 5-meter ceilings crisscrossed by original exposed steel I-beams and riveted iron trusses painted in matte black, showcasing the building's industrial heritage. One long wall is entirely original exposed red brick, aged and textured with decades of patina, while the opposite wall is finished in smooth polished concrete in warm grey. The floor is poured béton ciré in a warm charcoal tone, its surface reflecting the abundant natural light. A massive wall of steel-framed factory windows with multiple panes — classic atelier-style verrières — stretches from floor to ceiling along the far wall, flooding the space with bright diffused light and offering a view of the Poblenou skyline. The furnishings are contemporary high-end pieces that create a striking contrast with the raw industrial shell: a large deep sofa in rich cognac full-grain leather, a sculptural armchair in charcoal wool, a coffee table fashioned from a thick slab of live-edge walnut on a blackened steel base, and a tall minimalist brass floor lamp with a linen shade. A curated gallery wall of large-format black-and-white photographs in slim black frames hangs on the brick wall. An open kitchen area in the background features sleek matte black cabinetry, a thick Carrara marble waterfall countertop, and industrial-style pendant lights in black metal and smoked glass. A large fiddle-leaf fig tree in a matte black ceramic planter stands near the windows. The atmosphere is a perfect tension between raw industrial character and refined contemporary luxury — warm, textured, and deeply atmospheric. Photographed with a Canon EOS R5 and a 24mm wide-angle lens, photorealistic, ultra-detailed, 8K resolution. The space is empty with no people, no visible text, no watermarks, and no logos.
```
...
|---|-------------|-------|-------------|
| DI-1 | Visita consejo (étape 1) | Penthouse minimaliste contemporain — Diagonal Mar, double hauteur, vue mer, marbre blanc, noyer | `diseno-interiores-penthouse-minimalista-barcelona.jpg` |
| DI-2 | Estudio proyecto (étape 2) | Appartement art déco modernista — Eixample, moulures restaurées, hydrauliques, émeraude/laiton/velours | `diseno-interiores-art-deco-modernista-eixample.jpg` |
| DI-3 | Seguimiento obra (étape 3) | Loft industriel chic — Poblenou, poutrelles acier, briques, béton ciré, verrières d'atelier | `diseno-interiores-loft-industrial-poblenou-barcelona.jpg` |
